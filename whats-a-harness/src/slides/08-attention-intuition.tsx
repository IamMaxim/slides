  ...
  return (
    <div style={{ display: 'grid', gridTemplateRows: 'auto 1fr', height: '100%', gap: 24 }}>
      <Stack gap={12}>
        ...
        <SlideTitle size="md">Каждый токен может смотреть на те, что были до него.</SlideTitle>
      </Stack>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 48, alignItems: 'center' }}>
        <Stack gap={16}>
          <Build step={step} appearAt={0}>
            <BodyText>
              Возьми предложение. У каждого токена свой небольшой бюджет attention — он тратит его на предыдущие токены, которые важнее всего для того, что он должен здесь значить.
            </BodyText>
          </Build>
          <Build step={step} appearAt={1}>
            <BodyText>
              Для слова <span style={{ color: 'var(--accent)' }}>«it»</span> модели нужно понять, к чему «it» относится. Паттерн attention всё рассказывает: бо́льшая часть attention у «it» приходится на <span style={{ color: 'var(--accent)' }}>«cat»</span>.
            </BodyText>
          </Build>
          <Build step={step} appearAt={2}>
            <BodyText>
              Стрелки показывают эти веса. Толще = сильнее attention. Это происходит параллельно для каждого токена в последовательности, в каждом слое модели.
            </BodyText>
          </Build>
          <Build step={step} appearAt={3}>
            <BodyText>
              <span style={{ color: 'var(--ink)' }}>Наведи на любое слово</span>, чтобы увидеть, на что оно смотрит.
            </BodyText>
          </Build>
        </Stack>
