...
export const neuronSlide: Slide = {
  ...
  render: ({ step }) => (
    <Split
      ...
      left={
        <Stack gap={20}>
          <Eyebrow>строительный блок · 01</Eyebrow>
          <SlideTitle>Нейрон — это маленькая функция.</SlideTitle>
          <Stack gap={14} style={{ marginTop: 12 }}>
            <Build step={step} appearAt={1}>
              <BodyText>Он принимает несколько чисел — входы от других нейронов или из сырых данных.</BodyText>
            </Build>
            <Build step={step} appearAt={2}>
              <BodyText>
                Каждый вход он умножает на выученный <span style={{ color: 'var(--accent)' }}>вес</span> — ручку, которую сеть подкручивает во время обучения.
              </BodyText>
            </Build>
            <Build step={step} appearAt={3}>
              <BodyText>Складывает их.</BodyText>
            </Build>
            <Build step={step} appearAt={4}>
              <BodyText>
                Прогоняет сумму через нелинейную <span style={{ color: 'var(--accent)' }}>активацию</span> вроде ReLU или сигмоиды. (Именно это позволяет стопкам нейронов выучивать нетривиальные формы.)
              </BodyText>
            </Build>
            <Build step={step} appearAt={5}>
              <BodyText>И на выходе — одно число, которое становится входом для следующего слоя.</BodyText>
            </Build>
          </Stack>
        </Stack>
      }
