...
export const transformerBlockSlide: Slide = {
  ...
  render: ({ step }) => (
    <Split
      ...
      left={
        <Stack gap={20}>
          <Eyebrow>building block · 03</Eyebrow>
          <SlideTitle>The transformer block is two small networks glued together.</SlideTitle>
          <Stack gap={14} style={{ marginTop: 12 }}>
            <Build step={step} appearAt={1}>
              <BodyText>
                <span style={{ color: 'var(--accent)' }}>Self-attention</span> lets every token look at every other token in the sequence and pull in context.
                More on this in a few slides.
              </BodyText>
            </Build>
            <Build step={step} appearAt={2}>
              <BodyText>
                Then a tiny <span style={{ color: 'var(--cool)' }}>feed-forward network</span> runs over each token independently — that's the "actual neurons" part doing the heavy non-linear work.
              </BodyText>
            </Build>
            <Build step={step} appearAt={3}>
              <BodyText>
                <span style={{ color: 'var(--accent)' }}>Residual connections</span> add the input back to the output of each sublayer. They make training deep stacks feasible.
              </BodyText>
            </Build>
            <Build step={step} appearAt={4}>
              <BodyText>
                Sprinkle in layer-norm to keep activations well-scaled, and that's it: a single transformer block.
              </BodyText>
            </Build>
          </Stack>
        </Stack>
