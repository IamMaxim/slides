    ...
    <Split
      ...
      left={
        <Stack gap={20}>
          ...
          <SlideTitle size="md">Inside the box: a tiny matching system.</SlideTitle>
          <Stack gap={14} style={{ marginTop: 12 }}>
            <Build step={step} appearAt={0}>
              <BodyText>
                Each token vector is projected three times to make a{' '}
                <span style={{ color: 'var(--accent)' }}>query</span>, a{' '}
                <span style={{ color: 'var(--cool)' }}>key</span>, and a value.
                Think: "what am I looking for", "what do I offer", "what do I carry".
              </BodyText>
            </Build>
            <Build step={step} appearAt={1}>
              <BodyText>
                Compute the dot product of each query with every key. Bright cells = high score = good match.
                Cells above the diagonal are masked off — tokens can't see the future.
              </BodyText>
            </Build>
            <Build step={step} appearAt={2}>
              <BodyText>
                Apply softmax row-wise. Now each row is a probability distribution over keys — the attention weights.
              </BodyText>
            </Build>
            <Build step={step} appearAt={3}>
              <BodyText>
                Use those weights to take a weighted sum of <span style={{ color: 'var(--cool)' }}>value</span> vectors.
                That's the output for each token. Many heads do this in parallel with different projections.
              </BodyText>
            </Build>
          </Stack>
        </Stack>
